...
struct PersistenceController {
    ...
    static let preview: PersistenceController = {
        ...
        newPokemon.shinyURL = URL(string: "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/shiny/6.png")
...
//            fatalError("Unresolved error \(nsError), \(nsError.userInfo)")
    ...
    init(inMemory: Bool = false) {
        ...
        if inMemory {
            ...
            container.persistentStoreDescriptions.first!.url = FileManager.default.containerURL(forSecurityApplicationGroupIdentifier: "group.dev.stas.DexGroup")!.appending(path: "Dex.sqlite")
        }
